...
# Hashing
holder en nøkkel og en verdi
gjør om en nøkkel til å finne et tall i tabell


# seperate chaning
sette noe i en index i en array


# linear probling
nøkkel hashes til index bør ligge
finner første ledgie plass
plusser på 1
![[Pasted image 20241010144812.png]]
# double hasing
![[Pasted image 20241010144816.png]]
...
construtor lager bare setter bare opp miljø
insert setter in liste

verdier(char) blir blir gjort om til key (tall)
tar den k verdi(key) % med modverdi (som er tall vi bestemer i constructor) lengden på tabell

*BLIR SORTERT BASERT PÅ MODULO VERDI*
...
binært tre, alle INTERNENODE (ikke bladnoder) er en hash av sine barn
